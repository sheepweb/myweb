<template>
  <div class="log-list logs-page">
    <div class="filter-bar desktop-only">
      ...
      <el-select v-model="filter.action_by" placeholder="操作方" clearable style="width: 100px">
    ...
    <div class="filter-bar mobile-only">
      <el-form label-position="top" class="mobile-filter-form">
        ...
        <el-form-item label="操作类型">
          <el-select v-model="filter.action_type" placeholder="操作类型" clearable style="width: 100%">
            <el-option v-for="(label, value) in ACTION_TYPE_MAP" :key="value" :label="label" :value="value" />
          </el-select>
        </el-form-item>
        <el-form-item label="操作方">
          <el-select v-model="filter.action_by" placeholder="操作方" clearable style="width: 100%">
            <el-option label="用户" value="user" />
            <el-option label="管理员" value="admin" />
            <el-option label="系统" value="system" />
          </el-select>
